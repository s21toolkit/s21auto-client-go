...
type Data_CalendarAddEvent struct {
	Data_Student_CalendarAddEvent Data_Student_CalendarAddEvent `json:"student"`
}

type Data_Student_CalendarAddEvent struct {
	Data_AddEventToTimetable_CalendarAddEvent []Data_AddEventToTimetable_CalendarAddEvent `json:"addEventToTimetable"`
	Typename            string                `json:"__typename"`
}

type Data_AddEventToTimetable_CalendarAddEvent struct {
	ID                string        `json:"id"`
	Start             string        `json:"start"`
	End               string        `json:"end"`
	...
	EventSlots        []Data_EventSlot_CalendarAddEvent   `json:"eventSlots"`
...
type Data_EventSlot_CalendarAddEvent struct {
	ID       string `json:"id"`
